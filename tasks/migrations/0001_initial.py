    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_content', models.ForeignKey(limit_choices_to={'model__in': ('memo', 'project', 'task')}, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_content_related', to='contenttypes.contenttype', verbose_name='Tag for')),
            ],
            options={
                'verbose_name': 'Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_co_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Co-owner')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified_by_related', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ...
                ('stage', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='tasks.projectstage', verbose_name='Stage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notified_subscribers', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_notified_subscribers_related', to=settings.AUTH_USER_MODEL, verbose_name='Notified subscribers')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_project_related', to='tasks.project', verbose_name='project')),
                ('responsible', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_responsible_related', to=settings.AUTH_USER_MODEL, verbose_name='Responsible')),
                ('subscribers', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_subscribers_related', to=settings.AUTH_USER_MODEL, verbose_name='subscribers')),
                ('tags', models.ManyToManyField(blank=True, to='tasks.tag', verbose_name='Tags')),
                ('task', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_task_related', to='tasks.task', verbose_name='task')),
                ('stage', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.PROTECT, to='tasks.taskstage', verbose_name='Stage')),
            ],
            options={
                'verbose_name': 'Task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deal', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_related', to='crm.deal', verbose_name='Deal')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified_by_related', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('notified_subscribers', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_notified_subscribers_related', to=settings.AUTH_USER_MODEL, verbose_name='Notified subscribers')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('subscribers', models.ManyToManyField(blank=True, related_name='%(app_label)s_%(class)s_subscribers_related', to=settings.AUTH_USER_MODEL, verbose_name='subscribers')),
                ('to', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_to_whom_related', to=settings.AUTH_USER_MODEL, verbose_name='to whom')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_project_related', to='tasks.project', verbose_name='Project')),
                ('resolution', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_resolution_related', to='tasks.resolution', verbose_name='For what')),
                ('tags', models.ManyToManyField(blank=True, to='tasks.tag', verbose_name='Tags')),
                ('task', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_task_related', to='tasks.task', verbose_name='Task')),
            ],
            options={
                'verbose_name': 'Memo',
