    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=70)),
                ('department', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, to='auth.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=common.utils.helpers.token_default, max_length=11, unique=True)),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='crm.city', verbose_name='City')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_department_related', to='auth.group', verbose_name='Department')),
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='crm.clienttype', verbose_name='Type of company')),
                ('country', models.ForeignKey(blank=True, help_text='Company Country', null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='crm.country', verbose_name='country')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default=common.utils.helpers.token_default, max_length=11, unique=True)),
                ('city', models.ForeignKey(blank=True, help_text='Object of City in database', null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='crm.city', verbose_name='Company city')),
                ('company', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='contacts', to='crm.company', verbose_name='Company of contact')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_department_related', to='auth.group', verbose_name='Department')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified_by_related', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='crm.country', verbose_name='Country')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, to='crm.country', verbose_name='Country'),
        ),
        migrations.CreateModel(
            name='CrmEmail',
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='company_emails', to='crm.company', verbose_name='Company')),
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='contact_emails', to='crm.contact', verbose_name='Contact')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_department_related', to='auth.group', verbose_name='Department')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified_by_related', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
            ],
