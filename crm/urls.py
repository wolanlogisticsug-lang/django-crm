...
from crm.views.custom_dashboard import custom_dashboard
...
urlpatterns = [
    ...
    path(
        ...
        crm_staff_member_required(DeleteDuplicateObject.as_view()),
        name='delete_duplicate'
    ),

    path('change-owner-companies/', crm_staff_member_required(change_owner_companies),
         name='change_owner_companies'),

    path(
        'export-objects/', crm_staff_member_required(export_objects_view),
        name="export_objects"
    ),

    path(
        'create-email/<int:object_id>',
        crm_staff_member_required(create_email),
        name='create_email'
    ),
    path('reply_email/<int:object_id>/',
         crm_staff_member_required(reply_email), name='reply_email'),

    path(
        'print-email/<int:object_id>',
        crm_staff_member_required(DetailView.as_view(
    ...
    path(
        ...
        crm_staff_member_required(got_contacts_massmails),
        name='got_contacts_massmails'
    ),
    path(
        'got-company-massmails/<int:object_id>/',
        crm_staff_member_required(got_company_massmails),
        name='got_company_massmails'
    ),
    path(
        'got-leads-massmails/<int:object_id>/',
        crm_staff_member_required(got_leads_massmails),
        name='got_leads_massmails'
    ),
    path(
        'view-original-email/<int:object_id>/',
        crm_staff_member_required(view_original_email),
    ...
    path(
        ...
        crm_staff_member_required(download_original_email),
