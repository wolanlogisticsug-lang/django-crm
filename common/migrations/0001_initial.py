...
import WOLANCRM.contrib.auth.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Department',
            fields=[
                ('group_ptr', models.OneToOneField(auto_created=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='auth.group')),
            ...
            bases=('auth.group',),
            managers=[
                ('objects', WOLANCRM.contrib.auth.models.GroupManager()),
            ],
        ),
        migrations.CreateModel(
            name='Reminder',
        ...
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ('user', models.OneToOneField(on_delete=WOLANCRM.db.models.deletion.CASCADE, primary_key=True, related_name='profile', serialize=False, to=settings.AUTH_USER_MODEL)),
