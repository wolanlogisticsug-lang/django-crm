...
**WolanCRM** est une solution CRM open-source conçue avec deux objectifs principaux :
...
Cela permet à WolanCRM de stocker automatiquement des copies de toute la correspondance liée à chaque demande et affaire dans sa base de données.
