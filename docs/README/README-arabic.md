...
<a href="https://github.com/WOLANCRM/WolanCRM/blob/main/docs/README/README-arabic.md">
العربية</a> |
...
# نظام إدارة علاقات العملاء WolanCRM

*(برنامج إدارة علاقات العملاء التعاوني والتحليلي)*

**WolanCRM** هو حل مفتوح المصدر لإدارة علاقات العملاء مصمم بهدفين رئيسيين:
...
**لا حاجة لتعلم إطار عمل خاص**: كل شيء مبني باستخدام إطار عمل WOLANCRM الشهير.
يستفيد نظام إدارة علاقات العملاء أيضًا بشكل كامل من موقع إدارة WOLANCRM، مع توثيق كل شيء في صفحة ويب واحدة!

[<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/deals_screenshot.png" alt="لقطة شاشة لنظام إدارة علاقات العملاء WolanCRM" align="center" style="float: center"/>](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/deals_screenshot.png)
...
تعرف على المزيد حول [قدرات البرنامج](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/crm_system_overview.md).

نظام إدارة علاقات العملاء WOLANCRM هو برنامج مفتوح المصدر لإدارة علاقات العملاء. هذا النظام مكتوب بلغة <a href="https://www.python.org" target="_blank"><img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/python-logo.svg" style="vertical-align: middle" alt="شعار بايثون" width="25" height="25"> بايثون</a>.
الواجهة الأمامية والخلفية تعتمد بالكامل على موقع إدارة WOLANCRM.
يستخدم تطبيق إدارة علاقات العملاء قوالب HTML التكيفية للإدارة مباشرة.
WOLANCRM هو إطار عمل موثق بشكل ممتاز مع الكثير من الأمثلة.
التوثيق على موقع الإدارة يشغل صفحة ويب واحدة فقط.
💡 **الفكرة الأصلية** هي أنه بما أن إدارة WOLANCRM هي بالفعل واجهة احترافية لإدارة الكائنات مع نظام أذونات مرن للمستخدمين (عرض، تغيير، إضافة، وحذف الكائنات)، كل ما تحتاجه هو إنشاء نماذج للكائنات (مثل العملاء المحتملين، الطلبات، الصفقات، الشركات، إلخ) وإضافة منطق الأعمال.
...
- **تطبيق إدارة المهام**:
  ...
  - المهمة (مع الملفات ذات الصلة، الدردشة، التذكيرات، العلامات - انظر [ميزات المهمة](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md))
    - المهام الفرعية
  - المذكرة (مذكرة المكتب) - انظر [ميزات المذكرة](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md)
    - المهام / المشروع
  - المشروع (*مجموعة المهام*):
  - ... (+ *4 نماذج أخرى <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/tasks/models" target="_blank">نماذج</a>*)
- **تطبيق إدارة علاقات العملاء**:
  ...
  - ... (*+ 12 نموذجًا آخر <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/crm/models" target="_blank">نماذج</a>*)
[<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/income_summary_thumbnail.png" alt="تقرير تحليلي لنظام إدارة علاقات العملاء" align="right" width="190px" style="float: right"/>](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)
- **تطبيق التحليلات**: ([نظرة عامة مفصلة على البرنامج](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_analytics_app_overview.md))
  - تقرير ملخص الدخل (*انظر [لقطة الشاشة](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)*)
  - تقرير قمع المبيعات
...
يتيح ذلك لنظام إدارة علاقات العملاء WOLANCRM تخزين نسخ من جميع المراسلات المتعلقة بكل طلب وصفقة تلقائيًا داخل قاعدة بياناته.
...
- يتضمن أيضًا دليل مستخدم شامل [دليل المستخدم](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md) للرجوع إليه ودعمه بشكل متعمق.
...
يمكن توجيه [مذكرات المكتب](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md) إلى رؤساء الأقسام أو المديرين التنفيذيين للشركة، الذين يمكنهم بعد ذلك تحويل هذه المذكرات إلى مهام أو مشاريع، وتعيين الأشخاص المسؤولين أو المنفذين.
يمكن أن تكون [المهام](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md) فردية أو جماعية.
...
يدعم نظام إدارة علاقات العملاء WOLANCRM الترجمة الكاملة للواجهة، وتنسيق التواريخ، الأوقات، والمناطق الزمنية.
<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/languages.svg" alt="شعار WOLANCRM" width="30" height="30" style="vertical-align: middle"> برنامج خدمة العملاء متاح الآن بلغات **متعددة:**  
`de, en, es, fr, hi, it, nl, pt-BR, ru, uk`

## لماذا تختار نظام إدارة علاقات العملاء WOLANCRM؟
...
- **مبني على Python وWOLANCRM**: لا حاجة لإطارات عمل خاصة - كل شيء مبني على WOLANCRM بواجهة إدارة بديهية.

## البدء

يمكن نشر نظام إدارة علاقات العملاء WOLANCRM بسهولة كمشروع WOLANCRM عادي.

📚 يرجى الرجوع إلى:

- [دليل التثبيت والتكوين](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/installation_and_configuration_guide.md)
- [دليل المستخدم](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md)

إذا وجدت نظام إدارة علاقات العملاء WOLANCRM مفيدًا، يرجى ⭐️ **تقييم** هذا المستودع على GitHub لدعم نموه!
<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/WolanCRM_star_history.png" alt="تاريخ تقييم نظام إدارة علاقات العملاء WOLANCRM" align="center" style="float: center"/>
...
تحقق من [دليل المساهمة](https://github.com/WOLANCRM/WolanCRM/blob/main/CONTRIBUTING.md) لتتعلم كيفية البدء.
كل مساهمة، كبيرة أو صغيرة، تحدث فرقًا.

## الترخيص

تم إصدار نظام إدارة علاقات العملاء WOLANCRM تحت ترخيص AGPL-3.0 - انظر ملف [الترخيص](https://github.com/WOLANCRM/WolanCRM/blob/main/LICENSE) للحصول على التفاصيل.
