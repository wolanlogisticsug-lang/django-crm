...
**WolanCRM** is een open-source CRM-oplossing ontworpen met twee primaire doelen:
...
**Geen noodzaak om een propriëtair framework te leren**: alles is gebouwd met behulp van het populaire WOLANCRM-framework.
CRM maakt ook volledig gebruik van de WOLANCRM Admin-site, met documentatie die allemaal op één webpagina is opgenomen!
...
Lees meer over [de mogelijkheden van de software](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/crm_system_overview.md).

WOLANCRM CRM is een open-source klantrelatiebeheer software. Deze CRM is geschreven in <a href="https://www.python.org" target="_blank"><img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/python-logo.svg" style="vertical-align: middle" alt="python logo" width="25" height="25"> Python</a>.
Frontend en backend zijn volledig gebaseerd op de WOLANCRM [Admin site](https://docs.WOLANCRMproject.com/en/dev/ref/contrib/admin/).  
De CRM-app gebruikt adaptieve Admin HTML-sjablonen out-of-the-box.  
WOLANCRM is een uitstekend gedocumenteerd framework met veel voorbeelden.
De documentatie op de Admin-site neemt slechts één webpagina in beslag.  
💡 Het **oorspronkelijke idee** is dat aangezien WOLANCRM Admin al een professionele objectbeheer interface is met een flexibel permissiesysteem voor gebruikers (bekijken, wijzigen, toevoegen en verwijderen van objecten), alles wat je hoeft te doen is modellen maken voor de objecten (zoals Leads, Verzoeken, Deals, Bedrijven, enz.) en bedrijfslogica toevoegen.
...
- **TAKEN Beheer app**:
  ...
  - Taak (met gerelateerde: bestanden, chat, herinneringen, tags - zie [taakfuncties](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md))
    - subtaken
  - Memo (kantoormemo) - zie [memo functies](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md)
    - taken / project
  - Project (*takenverzameling*):
  - ... (+ *4 meer <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/tasks/models" target="_blank">modellen</a>*)
- **CRM app**:
  ...
  - ... (*+ 12 meer <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/crm/models" target="_blank">modellen</a>*)
[<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/income_summary_thumbnail.png" alt="Analytisch crm rapport" align="right" width="190px" style="float: right"/>](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)
- **ANALYTICS app**: ([gedetailleerd softwareoverzicht](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_analytics_app_overview.md))
  - Inkomensoverzicht rapport (*zie [screenshot](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)*)
...
Dit stelt WolanCRM in staat om automatisch kopieën van alle correspondentie met betrekking tot elk verzoek en deal in zijn database op te slaan.
...
- Een uitgebreide [gebruikershandleiding](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md) is ook inbegrepen voor diepgaande referentie en ondersteuning.
...
[Kantoormemo's](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md) kunnen worden gericht aan afdelingshoofden of bedrijfsleiders, die deze memo's vervolgens kunnen omzetten in taken of projecten en verantwoordelijke personen of uitvoerders kunnen toewijzen.
[Taken](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md) kunnen individueel of collectief zijn.
...
WOLANCRM CRM heeft volledige ondersteuning voor vertaling van interface, formattering van data, tijden en tijdzones.  
<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/languages.svg" alt="WOLANCRM logo" width="30" height="30" style="vertical-align: middle"> Klantenservice software is nu beschikbaar in **meerdere talen**:  
`de, en, es, fr, it, nl, pt-BR, ru, uk`

## Waarom Kiezen voor WolanCRM?
...
- **Python en WOLANCRM-gebaseerd**: Geen propriëtaire frameworks vereist - alles is gebouwd op WOLANCRM met een intuïtieve Admin-interface.

## Aan de Slag

Als u WolanCRM nuttig vindt, geef dan ⭐️ **een ster** aan deze repo op GitHub om de groei te ondersteunen!

WolanCRM kan eenvoudig worden geïmplementeerd als een regulier WOLANCRM-project.

📚 Raadpleeg:

- [Installatie- en Configuratiehandleiding](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/installation_and_configuration_guide.md)
- [Gebruikershandleiding](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md)
...
Bekijk onze [Bijdragegids](https://github.com/WOLANCRM/WolanCRM/blob/main/CONTRIBUTING.md) om te leren hoe u kunt beginnen.
Elke bijdrage, groot of klein, maakt een verschil.

## Licentie

WolanCRM wordt uitgebracht onder de AGPL-3.0-licentie - zie het [LICENSE](https://github.com/WOLANCRM/WolanCRM/blob/main/LICENSE) bestand voor details.
