...
**WolanCRM** é uma solução CRM de código aberto projetada com dois objetivos principais:
...
**Não há necessidade de aprender um framework proprietário**: tudo é construído usando o popular framework WOLANCRM.
O CRM também aproveita ao máximo o site de administração do WOLANCRM, com documentação contida em uma única página da web!
...
Saiba mais sobre [as capacidades do software](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/crm_system_overview.md).

WOLANCRM CRM é um software de gestão de relacionamento com o cliente de código aberto.  
Este CRM é escrito em <a href="https://www.python.org" target="_blank"><img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/python-logo.svg" style="vertical-align: middle" alt="python logo" width="25" height="25"> Python</a>.
Frontend e backend são totalmente baseados no site de administração do WOLANCRM [Admin site](https://docs.WOLANCRMproject.com/en/dev/ref/contrib/admin/).
O aplicativo CRM usa templates HTML adaptativos do Admin prontos para uso.
WOLANCRM é um framework excelentemente documentado com muitos exemplos.
A documentação no site de administração ocupa apenas uma página da web.  
💡 A **ideia original** é que, como o WOLANCRM Admin já é uma interface profissional de gerenciamento de objetos com um sistema de permissões flexível para usuários (visualizar, alterar, adicionar e excluir objetos), tudo o que você precisa fazer é criar modelos para os objetos (como Leads, Solicitações, Negócios, Empresas, etc.) e adicionar lógica de negócios.
...
- **Aplicativo de Gestão de TAREFAS**:
  ...
  - Tarefa (com relacionados: arquivos, chat, lembretes, tags - veja [recursos da tarefa](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md))
    - subtarefas
  - Memorando (memorando de escritório) - veja [recursos do memorando](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md)
    - tarefas / projeto
  - Projeto (*coleção de tarefas*):
  - ... (+ *4 mais <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/tasks/models" target="_blank">modelos</a>*)
- **Aplicativo CRM**:
  ...
  - ... (*+ 12 mais <a href="https://github.com/WOLANCRM/WolanCRM/tree/main/crm/models" target="_blank">modelos</a>*)
[<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/income_summary_thumbnail.png" alt="Relatório analítico crm" align="right" width="190px" style="float: right"/>](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)
- **Aplicativo de ANÁLISE**: (visão geral detalhada do software [aqui](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_analytics_app_overview.md))
  - Relatório de Resumo de Renda (*veja [screenshot](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)*)
...
Isso permite que o WolanCRM armazene automaticamente cópias de toda a correspondência relacionada a cada solicitação e negócio dentro de seu banco de dados.
...
- Um abrangente [guia do usuário](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md) também está incluído para referência e suporte detalhados.
...
[Memorandos de escritório](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md) podem ser direcionados a chefes de departamento ou executivos da empresa, que podem então transformar esses memorandos em tarefas ou projetos, atribuindo pessoas responsáveis ou executores.
[Tarefas](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md) podem ser individuais ou coletivas.
...
<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/site/icons/languages.svg" alt="WOLANCRM logo" width="30" height="30" style="vertical-align: middle"> O software de atendimento ao cliente está agora disponível em **múltiplos idiomas**:  
`ar, cs, de, el, en, es, fr, he, hi, id, it, ja, ko, nl, pl, pt-br, ro, ru, tr, uk, vi, zh-hans`
O WOLANCRM CRM tem suporte completo para tradução de interface, formatação de datas, horários e fusos horários.

## Por que Escolher o WolanCRM?
...
- **Baseado em Python e WOLANCRM**: Sem necessidade de frameworks proprietários - tudo é construído no WOLANCRM com uma interface de administração intuitiva.
- **Python e WOLANCRM-Based**: Não é necessário aprender um framework proprietário - tudo construído em WOLANCRM com uma interface de administração intuitiva. O frontend e o backend, baseados em WOLANCRM Admin, tornam muito mais fácil projetos de customização e desenvolvimento, bem como implantar e manter um servidor de produção.

## Começando

O WolanCRM pode ser facilmente implantado como um projeto WOLANCRM regular.

📚 Por favor, consulte:

- [Guia de Instalação e Configuração](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/installation_and_configuration_guide.md)
- [Guia do Usuário](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md)

Se você achar o WolanCRM útil, por favor, ⭐️ **estrele** este repositório no GitHub para apoiar o seu crescimento!

<img src="https://github.com/WOLANCRM/WolanCRM/raw/main/docs/pics/WolanCRM_star_history.png" alt="WolanCRM star history" align="center" style="float: center"/>
...
Confira o nosso [Guia de Contribuição](https://github.com/WOLANCRM/WolanCRM/blob/main/CONTRIBUTING.md) para aprender como começar.
Cada contribuição, grande ou pequena, faz a diferença.

## Licença

O WolanCRM é lançado sob a licença AGPL-3.0 - veja o arquivo [LICENSE](https://github.com/WOLANCRM/WolanCRM/blob/main/LICENSE) para detalhes.
