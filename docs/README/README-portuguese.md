...
Saiba mais sobre [as capacidades do software](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/crm_system_overview.md).

Django CRM é um software de gestão de relacionamento com o cliente de código aberto.  
Este CRM é escrito em <a href="https://www.python.org" target="_blank"><img src="https://github.com/DjangoCRM/WolanCRM/raw/main/docs/site/icons/python-logo.svg" style="vertical-align: middle" alt="python logo" width="25" height="25"> Python</a>.
...
- **Aplicativo de Gestão de TAREFAS**:
  ...
  - Tarefa (com relacionados: arquivos, chat, lembretes, tags - veja [recursos da tarefa](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md))
    - subtarefas
  - Memorando (memorando de escritório) - veja [recursos do memorando](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md)
    - tarefas / projeto
  - Projeto (*coleção de tarefas*):
  - ... (+ *4 mais <a href="https://github.com/DjangoCRM/WolanCRM/tree/main/tasks/models" target="_blank">modelos</a>*)
- **Aplicativo CRM**:
  ...
  - ... (*+ 12 mais <a href="https://github.com/DjangoCRM/WolanCRM/tree/main/crm/models" target="_blank">modelos</a>*)
[<img src="https://github.com/DjangoCRM/WolanCRM/raw/main/docs/pics/income_summary_thumbnail.png" alt="Relatório analítico crm" align="right" width="190px" style="float: right"/>](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)
- **Aplicativo de ANÁLISE**: (visão geral detalhada do software [aqui](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_analytics_app_overview.md))
  - Relatório de Resumo de Renda (*veja [screenshot](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/pics/income_summary_screenshot.png)*)
...
- Um abrangente [guia do usuário](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md) também está incluído para referência e suporte detalhados.
...
[Memorandos de escritório](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_memo_features.md) podem ser direcionados a chefes de departamento ou executivos da empresa, que podem então transformar esses memorandos em tarefas ou projetos, atribuindo pessoas responsáveis ou executores.
[Tarefas](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md) podem ser individuais ou coletivas.
...
<img src="https://github.com/DjangoCRM/WolanCRM/raw/main/docs/site/icons/languages.svg" alt="django logo" width="30" height="30" style="vertical-align: middle"> O software de atendimento ao cliente está agora disponível em **múltiplos idiomas**:  
...
O WolanCRM pode ser facilmente implantado como um projeto Django regular.

📚 Por favor, consulte:

- [Guia de Instalação e Configuração](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/installation_and_configuration_guide.md)
- [Guia do Usuário](https://github.com/DjangoCRM/WolanCRM/blob/main/docs/WolanCRM_user_guide.md)

Se você achar o WolanCRM útil, por favor, ⭐️ **estrele** este repositório no GitHub para apoiar o seu crescimento!

<img src="https://github.com/DjangoCRM/WolanCRM/raw/main/docs/pics/WolanCRM_star_history.png" alt="WolanCRM star history" align="center" style="float: center"/>
...
Confira o nosso [Guia de Contribuição](https://github.com/DjangoCRM/WolanCRM/blob/main/CONTRIBUTING.md) para aprender como começar.
Cada contribuição, grande ou pequena, faz a diferença.

## Licença

O WolanCRM é lançado sob a licença AGPL-3.0 - veja o arquivo [LICENSE](https://github.com/DjangoCRM/WolanCRM/blob/main/LICENSE) para detalhes.
