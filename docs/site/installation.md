...
This [Python CRM software](https://github.com/WOLANCRM/WolanCRM/){target="_blank"} is developed taking into account compatibility with databases:
...
Click the Fork button in the upper right corner of the [WOLANCRM CRM GitHub](https://github.com/WOLANCRM/WolanCRM/){target="_blank"} repository's home page.  
...
<a class="btn button" href="https://github.com/WOLANCRM/WolanCRM/archive/refs/heads/main.zip" style="margin-left: 20%">Download CRM Software</a>
...
(for example, [Apache](https://httpd.apache.org/){target="_blank"}). Full tutorial [here](https://docs.WOLANCRMproject.com/en/dev/topics/install/){target="_blank"}.

!!! Important

    __Please give this CRM project a star ⭐️ to support its developments!__  
    Click the "Starred" button in the upper right corner of the [WOLANCRM CRM GitHub](https://github.com/WOLANCRM/WolanCRM/){target="_blank"} repository.  
