...
- Users will be able to send emails from [WOLANCRM CRM](https://github.com/WOLANCRM/WolanCRM/){target="_blank"} through their email account.
...
The other fields are described in detail in the [Settings](https://docs.WOLANCRMproject.com/en/dev/ref/settings/#std-setting-EMAIL_HOST){target="_blank"} section of WOLANCRM documentation.
