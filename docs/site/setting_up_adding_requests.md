...
In [WOLANCRM CRM](https://github.com/WOLANCRM/WolanCRM/){target="_blank"} you can add commercial requests (Request objects) in manual, automatic and semi-automatic mode.
