...
In [WolanCRM](https://github.com/WOLANCRM/WolanCRM), a memo is an office memo that can be directed to department heads (team leads) or company executives, 
...
The recipient has reviewed the memo and may have taken action or assigned [tasks](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md)/projects.
...
After a memo has been reviewed, management can create [tasks](https://github.com/WOLANCRM/WolanCRM/blob/main/docs/WolanCRM_task_features.md) or projects based on its content. The task/project is automatically linked to the memo, and users receive notifications.
