    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_import_dt', models.DateTimeField(default=WOLANCRM.utils.timezone.now, verbose_name='DateTime of last import')),
                ('co_owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_co_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Co-owner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='queue_owners', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='EmlMessage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='content_types', to='contenttypes.contenttype', verbose_name='Recipients type')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_department_related', to='auth.group', verbose_name='Department')),
                ('message', models.ForeignKey(null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='mailing_outs', to='massmail.emlmessage', verbose_name='Message')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_modified_by_related', to=settings.AUTH_USER_MODEL, verbose_name='Modified By')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_owner_related', to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('email_account', models.ForeignKey(blank=True, null=True, on_delete=WOLANCRM.db.models.deletion.CASCADE, to='massmail.emailaccount')),
            ],
        ),
        migrations.CreateModel(
            name='Signature',
