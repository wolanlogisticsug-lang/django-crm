    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=WOLANCRM.db.models.deletion.CASCADE, to='help.page')),
                ...
                ('link1', models.ForeignKey(blank=True, help_text='Link to a related paragraph if exists.', null=True, on_delete=WOLANCRM.db.models.deletion.SET_NULL, to='help.paragraph')),
            ],
            options={
